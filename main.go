...
func main() {
    ...
    servicesContainer = services.NewContainer(&utils.Logger{}, &utils.Environment{})
    dbConnection := getDbConnection()
    repositoriesContainer := repositories.NewContainer(repositories.NewOtpRepository(dbConnection))
    handlersContainer = handlers.NewContainer(handlers.NewOtpHandler(servicesContainer.Logger, repositoriesContainer.OtpRepository))
